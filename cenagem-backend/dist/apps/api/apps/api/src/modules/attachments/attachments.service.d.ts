...
export declare class AttachmentsService {
    ...
    createForFamily(familyId: string, input: CreateAttachmentDto, actor?: ActiveUserData): Promise<AttachmentDetailDto>;
    create(input: CreateAttachmentDto, actor?: ActiveUserData): Promise<AttachmentDetailDto>;
