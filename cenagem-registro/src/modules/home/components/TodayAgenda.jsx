    ...
    >
      ...
      <label className="text-xs uppercase tracking-wide text-slate-500 flex flex-col gap-1">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="px-2 py-1 rounded-lg border border-slate-300 text-[11px] font-medium uppercase tracking-wide !text-white hover:bg-slate-100 disabled:opacity-50"
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl border border-slate-300 hover:bg-slate-50 text-sm !text-white"
        >
          Cancelar
        </button>
      </div>
